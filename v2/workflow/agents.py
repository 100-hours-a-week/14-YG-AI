...
def create_base_llm(temperature: float = None) -> ChatVertexAI:
    ...
    """
    temp = temperature if temperature is not None else settings.workflow.default_agent_temperature
...
def validate_agent_configuration() -> dict:
    ...
    try:
        ...
        try:
            ...
            agents_status["participate_agent"] = {"status": "ok", "name": participate_agent.name}
        except Exception as e:
